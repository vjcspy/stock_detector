...
export class AppController {
  ...
  async getHello() {
    const res = await fetch('https://finance.vietstock.vn/data/financeinfo', {
      ...
      body: 'Code=BFC&ReportType=CDKT&ReportTermType=1&Unit=1000000000&Page=2&PageSize=4&__RequestVerificationToken=xDCPawNqxeiYnYsx5bFkurVak8dfP8VbBu9EnyPQ8FdDbi_-OTfrfbiO5Ux5vhSPJrXG_CZq4oSGAdYi65iCtXihTh_qMMvt9jQMgntoO9moZCg5A91mJf747JS8Ua4A0',
      method: 'POST',
    });
